...
const omi = {
  ...
  languages: ["Dart", "JavaScript", "TypeScript", "JAVA", "PHP", "C++", "C"],
  askMeAbout: [
    "Flutter",
    "Native",
  ...
  technologies: {
    ...
    tools: ["Git", "GitHub", "VS Code", "VS Codium", "Android Studio", "Linux"],
    integrations: ["REST APIs", "JSON Serialization", "Push Notifications"],
    realtimeAndAPIs: [
      "REST APIs",
      "WebSockets",
      "Socket.IO",
  ...
  funFact:
    "I enjoy turning app ideas into clean, scalable, and user-friendly mobile experiences."
};
